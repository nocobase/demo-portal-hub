    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
          What's documented, what's still in draft, and the articles people read
          most.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1fr_1.4fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Published versus draft.</CardDescription>
          </CardHeader>
          <CardContent>
            {stats.isLoading ? (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>The articles your team reads most.</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                >
                  ...
                  <div className="flex shrink-0 items-center gap-3">
                    <StatusPill
                      ...
                      label={labelFor(ARTICLE_STATUSES, article.status ?? "draft")}
                    />
