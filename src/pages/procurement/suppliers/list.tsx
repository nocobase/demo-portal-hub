...
function SupplierList() {
    ...
    return [
      columnHelper.accessor("name", {
        ...
        header: ({ column, table }) => (
          <div className="flex items-center gap-1">
            <span>
              {translate("procurement.suppliers.fields.name", { ns: "starter" }, "Supplier")}
            </span>
      ...
      columnHelper.accessor("rating", {
        ...
        header: ({ column }) => (
          <div className="flex items-center gap-1">
            <span>
              {translate("procurement.suppliers.fields.rating", { ns: "starter" }, "Rating")}
            </span>
            <DataTableSorter column={column} />
          </div>
        ),
      ...
      columnHelper.accessor("status", {
        ...
        header: ({ column, table }) => (
          <div className="flex items-center gap-1">
            <span>
              {translate("procurement.suppliers.fields.status", { ns: "starter" }, "Status")}
            </span>
            <DataTableFilterCombobox
              column={column}
              table={table}
  ...
  }, [openChild, statusOptions, translate]);
